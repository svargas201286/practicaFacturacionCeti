...
//crear el PDF
$pdf = new FPDF();
$pdf->AddPage('P', 'A4'); //configura la orientacion y el tamaño de la pagina
...
$pdf->Ln(10);
$pdf->Cell(170, 6, utf8_decode('Este comprobante puede ser valdidado en ceti.org o sunat.org.pe'), 0, 0, 'C', 0);


//salida del pdf
$pdf->Output('I', 'inovice.pdf');
