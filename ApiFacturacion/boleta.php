...
$comprobante = array(
    'tipodoc'                   =>  '03', //factura= 01, boleta = 03
    'serie'                     =>  'B123',
    'correlativo'               =>  '1',
...
$objXML->crea_xml_invoice($rutaXML . $nombreXML, $emisor, $cliente, $comprobante, $detalle, null);
echo '</br> PARTE 01: XML DE BOLETA CREADA';
