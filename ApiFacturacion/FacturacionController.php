...
require_once("../models/"); //../api_genera_xml.php
require_once("../models"); //../api_facturacion.php
require_once("../models"); //../cantidad_en_letras.php

$accion = $_POST['accion'];
operaciones($accion); //ejecutamos el llamado a la funcion oeraciones
