    ...
    if ($_GET['op'] == 'listProductos') { // PROBADO -- PODRIA MEJORARSE
        ...
        if ($datos) {
            ...
            <tr>
                ...
                <td>{$lisProducto->nombre}</td>                
                <td>{$lisProducto->unidad}</td>
                ...
                <td class='td-actions'> 
                     ...
                     <button data-IdPersona='{$lisProducto->idItem}' type='button' rel='tooltip' style='color:black' class='get btn btn-info btn-round' data-original-title='' title='Ver'>
                        <i class='material-icons'>visibility</i>
                     </button>

                     <button  data-IdPersona='{$lisProducto->idItem}' type='button' rel='tooltip' style='color:black' class='editar btn btn-success btn-round' title='Editar'>
                     <i class='material-icons'>edit</i>
                     </button>

                    <button data-IdPersona='{$lisProducto->idItem}' type='button' rel='tooltip' style='color:black' class='btn btn-danger btn-round' data-original-title='' title='Eliminar'>
